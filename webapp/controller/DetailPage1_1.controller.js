...
], function(BaseController, MessageBox, Dialog3, Dialog5, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.purchaseOrders.controller.DetailPage1_1", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "PurchaseOrderSet('1111122222')";
			}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("DetailPage1_1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_IconTabBar_Page_0-content-sap_m_IconTabBar-2-items-sap_m_IconTabFilter-1-content-build_simple_Table-1585152210804",
				"groups": ["items"]
			}, {
				"controlId": "sap_IconTabBar_Page_0-content-sap_m_IconTabBar-2-items-sap_m_IconTabFilter-5-content-sap_m_Panel-1585234994062-content-build_simple_Table-1",
				"groups": ["items"]
			}, {
				"controlId": "sap_IconTabBar_Page_0-content-sap_m_IconTabBar-2-items-sap_m_IconTabFilter-3-content-sap_m_Panel-1585068693929-content-build_simple_Table-1585070493331",
				"groups": ["items"]
			}];
